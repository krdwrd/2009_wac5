...
i.e.~the quirks of handling languages like Chinese and Japanese, or even bi-directional languages like Hebrew are transparent to our processing and the subsequent applications need to be capable of handling these languages.
