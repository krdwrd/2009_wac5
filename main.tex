...
To populate the proxy, we run the Application on every URL once and also extracted the pages' text.
...
Although the results for the single pipelines look quite promising - especially the visual pipeline performs surprisingly well given its limited input - combinations of feature sets in a single SVM model perform only marginally better.
